...
<link rel="stylesheet" type="text/css" href="{$theme_path}/style.css?v=1.7.2" />
...
<div class="fix_main noprint">
    ...
    <div class="top_block">
        ...
        <div class="boxed header-titles" style="max-width:100%;">
            <div class="site-title boxed"><a href="/" title="Купить стероиды, анаболики, заказать анаболические стероиды в интернет-магазине">Kachay-Zhelezo.art</a></div>
