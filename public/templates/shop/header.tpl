...
<link rel="stylesheet" type="text/css" href="{$theme_path}/style.css?v=1.5.1" />
...
<div class="fix_main noprint">
    ...
    <div class="top_block">
        ...
        <div class="left_top_block">
            <a rel="nofollow" href="/" title="{$smarty.server.HTTP_HOST} - главная страница"><img src="{$theme_path}/images/logo.gif" alt="logo" title="{$smarty.server.HTTP_HOST}" /></a>
        </div>
        <div class="boxed header-titles">
            <div class="site-title boxed">Kachay-Zhelezo.net</div>
            <h2 class="site-title-2 boxed">магазин спортивной фармакологии</h2>
        </div>
